...
function setup() {
  ...
  playerOne = new Player(color(0,255,0), parseInt(random(0,displaySize)), parseInt(random(0,displaySize)), displaySize);   // Initializing players

  target = new Player(color(255,0,0), parseInt(random(0,displaySize)), parseInt(random(0,displaySize)), displaySize);    // Initializing target using the Player class 
